...
import no.fint.personnel.model.kodeverk.AktivitetRepository;
...
@Component
public class AktivitetHandler implements Handler {
    private final AktivitetRepository repository;

    public AktivitetHandler(AktivitetRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_AKTIVITET.name());
    }
}
