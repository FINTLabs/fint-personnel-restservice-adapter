...
import no.fint.personnel.model.kodeverk.FunksjonRepository;
...
@Component
public class FunksjonHandler implements Handler {
    private final FunksjonRepository repository;

    public FunksjonHandler(FunksjonRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_FUNKSJON.name());
    }
}
