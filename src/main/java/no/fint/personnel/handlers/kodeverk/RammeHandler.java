...
import no.fint.personnel.model.kodeverk.RammeRepository;
...
@Component
public class RammeHandler implements Handler {
    private final RammeRepository repository;

    public RammeHandler(RammeRepository repository) {
