...
import no.fint.personnel.model.kodeverk.ArtRepository;
...
@Component
public class ArtHandler implements Handler {
    private final ArtRepository repository;

    public ArtHandler(ArtRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_ART.name());
    }
}
