...
import no.fint.personnel.model.kodeverk.DiverseRepository;
...
@Component
public class DiverseHandler implements Handler {
    private final DiverseRepository repository;

    public DiverseHandler(DiverseRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_DIVERSE.name());
    }
}
