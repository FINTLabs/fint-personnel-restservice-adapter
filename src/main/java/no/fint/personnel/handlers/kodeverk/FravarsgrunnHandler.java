...
import no.fint.personnel.model.kodeverk.FravarsgrunnRepository;
...
@Component
public class FravarsgrunnHandler implements Handler {
    private final FravarsgrunnRepository repository;

    public FravarsgrunnHandler(FravarsgrunnRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_FRAVARSGRUNN.name());
    }
}
