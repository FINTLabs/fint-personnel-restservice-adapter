...
import no.fint.personnel.model.kodeverk.ObjektRepository;
...
@Component
public class ObjektHandler implements Handler {
    private final ObjektRepository repository;

    public ObjektHandler(ObjektRepository repository) {
