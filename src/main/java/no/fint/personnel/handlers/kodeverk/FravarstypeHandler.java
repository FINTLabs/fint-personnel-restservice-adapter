...
import no.fint.personnel.model.kodeverk.FravarstypeRepository;
...
@Component
public class FravarstypeHandler implements Handler {
    private final FravarstypeRepository repository;

    public FravarstypeHandler(FravarstypeRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_FRAVARSTYPE.name());
    }
}
