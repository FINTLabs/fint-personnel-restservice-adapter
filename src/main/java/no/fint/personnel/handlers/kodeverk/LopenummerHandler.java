...
import no.fint.personnel.model.kodeverk.LopenummerRepository;
...
@Component
public class LopenummerHandler implements Handler {
    private final LopenummerRepository repository;

    public LopenummerHandler(LopenummerRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_LOPENUMMER.name());
    }
}
