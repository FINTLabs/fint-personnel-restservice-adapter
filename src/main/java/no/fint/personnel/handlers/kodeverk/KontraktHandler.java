...
import no.fint.personnel.model.kodeverk.KontraktRepository;
...
@Component
public class KontraktHandler implements Handler {
    private final KontraktRepository repository;

    public KontraktHandler(KontraktRepository repository) {
