...
import no.fint.personnel.model.kodeverk.AnsvarRepository;
...
@Component
public class AnsvarHandler implements Handler {
    private final AnsvarRepository repository;

    public AnsvarHandler(AnsvarRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_ANSVAR.name());
    }
}
