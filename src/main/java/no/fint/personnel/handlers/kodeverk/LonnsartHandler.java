...
import no.fint.personnel.model.kodeverk.LonnsartRepository;
...
@Component
public class LonnsartHandler implements Handler {
    private final LonnsartRepository repository;

    public LonnsartHandler(LonnsartRepository repository) {
    ...
    public Set<String> actions() {
        return Collections.singleton(KodeverkActions.GET_ALL_LONNSART.name());
    }
}
