package no.fint.personnel.behaviour;
...
@Service
public class RejectFastlonnWithoutRequiredLinks implements Behaviour<FastlonnResource> {
    @Override
    public void accept(Event event, FastlonnResource resource) {
